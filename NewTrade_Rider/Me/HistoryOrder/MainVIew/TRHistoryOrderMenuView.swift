...
import RxCocoa
import RxSwift
class TRHistoryOrderMenuView: UIView {
    ...
    private func setupView(){
        ...
        menuLab1.font = UIFont.trBoldFont(fontSize: 16)
        self.addSubview(menuLab1)
        
        menuLab2 = UILabel()
        menuLab2.text = "已取消"
        menuLab2.textColor = UIColor.hexColor(hexValue: 0x97989A)
        menuLab2.font = UIFont.trFont(fontSize: 16)
        self.addSubview(menuLab2)
        
        menuLab3 = UILabel()
        menuLab3.text = "已转单"
        menuLab3.textColor = UIColor.hexColor(hexValue: 0x97989A)
    ...
    private func configChangeState(state : Int){
       let labArr = [menuLab1, menuLab2, menuLab3]
        for index in 0 ..< labArr.count {
            ...
            if index == currentSel {
                lab.textColor = UIColor.hexColor(hexValue: 0x141414)
                lab.font = UIFont.trBoldFont(fontSize: 16)
