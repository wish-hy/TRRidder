//
//  TRPickupsetSelectTableViewCell.swift
//  NewTrade_Rider
//
...
import RxSwift
import RxCocoa
class TRPickupsetSelectTableViewCell: UITableViewCell {
    ...
    private func setupView(){
        ...
        valeTextField.isUserInteractionEnabled = false
        valeTextField.font = UIFont.trFont(fontSize: 15)
        valeTextField.text = "兴东地铁站D出口"
        valeTextField.textAlignment = .right
        valeTextField.textColor = UIColor.hexColor(hexValue: 0x141414)
