//
//  TRHomeMainCollectionViewCell3.swift
//  NewTrade_Rider
//
...
import UIKit
 ...
 // MARK: 配送中页面
class TRHomeMainCollectionViewCell3: UICollectionViewCell , UITableViewDelegate, UITableViewDataSource{
    ...
    private func setupView(){
        ...
        tableView.register(TRHomeDoneTableViewCell.self, forCellReuseIdentifier: "cell1")
    ...
    private func configData(){
        ...
        TRNetManager.shared.post_no_lodding(url: URL_Order_Delivering, pars: pars) {[weak self] dict in
            guard let self = self else {return}
...
//                }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell1", for: indexPath) as! TRHomeDoneTableViewCell
