...
class TRRiderTrainReasonCell: UITableViewCell {
    ...
    private func setupView(){
        ...
        reasonBgView.backgroundColor = .hexColor(hexValue: 0xF4F6F8)
        ...
        resonLab.snp.makeConstraints { make in
            make.left.right.equalTo(reasonBgView).inset(10)
            make.top.equalTo(reasonBgView).offset(10)
            make.bottom.equalTo(reasonBgView).inset(12)
        }
