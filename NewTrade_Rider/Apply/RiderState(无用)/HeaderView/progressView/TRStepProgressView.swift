...
class TRStepProgressView: UIView {
    ...
    private var items : [TRStepProgressItemView] = []
        ...
        didSet {
            ...
            for i in 0...items.count - 1 {
                ...
                if i != items.count - 1 {
                    ...
                    if i <= progress - 1 {
                        arrowImgV.image = UIImage(named: "progress_arrow_sel")
                    } else {
                        arrowImgV.image = UIImage(named: "progress_arrow_nor")
                    }
                }
            }
        }
    ...
    private func setupView(){
        ...
        for i in 0...titles.count - 1 {
            let t = titles[i]
            let itemView = TRStepProgressItemView(frame: .zero)
            ...
            if i != titles.count - 1 {
                let imgV = UIImageView(image: UIImage(named: "progress_arrow_nor"))
