...
{
    AMapNaviTypeInvalid = 0,        //!< 无效值
    AMapNaviTypeDrive   = 1,        //!< 驾车
    AMapNaviTypeRide    = 2,        //!< 骑行（自行车）
    AMapNaviTypeWalk    = 3,        //!< 步行
    AMapNaviTypeEleBike = 4,        //!< 骑行（电动车）
};
...
@property (nonatomic, assign) NSInteger eventType __attribute__((deprecated("该字段已废弃，since 7.0.0")));
